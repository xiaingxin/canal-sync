...
import com.assionx.canal.client.exception.SycIOException;
...
public class SycCanalConnector implements CanalConnector {

    private static final Logger  logger                = LoggerFactory.getLogger(SycCanalConnector.class);
    ...
    public SycCanalConnector(SocketAddress address, String username, String password, String destination){
